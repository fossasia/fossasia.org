$(document).ready(function() {
  ...
  if (
    $(".sidebar-menu-toggle").length &&
    !$(".sidebar-menu-toggle i").hasClass("variant-deleted-mrv")
  ) {
    $("nav")
      .find(".menu")
      .css("margin-right", 32);
  ...
  $(".speaker-column").on("mouseleave", function() {
    $(this)
      .children(".speaker-bio-tooltip-pin")
      .css("display", "none");
    $(this)
      .children(".speaker-bio-tooltip")
      .css("display", "none");
  });

  // Scroll to top button
  var btn = $('<button id="scrollToTop" class="fa fa-caret-up"> </button>');
  $("body.no-loader").prepend(btn);
  ...
  $("form.mail-list-signup").on("submit", function() {
    var iFrame = $(this)
      ...
      userFirstName = $(this)
        ...
        .val(),
      userLastName = $(this)
        .find(".signup-last-name-field")
        .val();

    iFrame
      .contents()
      .find("#mce-EMAIL, #fieldEmail")
      .val(userEmail);
    iFrame
      .contents()
      .find("#mce-LNAME, #fieldLastName")
      .val(userLastName);
    iFrame
      .contents()
