...
function parser(data) {
  ...
  var tweetAge =
    Math.round(difference / 1000 / 3600) > 24
      ? Math.round(difference / 1000 / 3600 / 24) + " days ago"
      : Math.round(difference / 1000 / 3600) + " hours ago";
  ...
  loklakFetcher = {
    ...
    getTweets: function (options, callback) {
      if (typeof options === "function") {
        // A callback has been provided as 2nd
        // argument (no options)
        var callback = options;
        options = {};
      } else if (callback === undefined) {
        // No callback has been provided, even
        // as 2nd argument
